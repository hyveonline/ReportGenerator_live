-- Update Email Templates to use "business days" wording
-- Run this after creating the business days functions

USE FoodSafetyDB_Live;
GO

-- Update Action Plan Reminder Template
UPDATE EmailTemplates 
SET 
    subject_template = 'Action Plan Reminder - {{storeName}} ({{documentNumber}}) - {{daysRemaining}} Business Days Left',
    html_body = '<div style="font-family: Segoe UI, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #fff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
            ...
            <p>This is a reminder that the <strong>Action Plan</strong> for the following audit is due in <strong style="color: #d97706;">{{daysRemaining}} business day(s)</strong>:</p>
            ...
            <p style="font-size: 12px; color: #6b7280;">Note: Business days are Monday through Friday, excluding weekends.</p>
...
PRINT 'Updated action_plan_reminder template';

-- Update Action Plan Escalation Template (sent to Area Manager)
UPDATE EmailTemplates 
SET 
    html_body = '<div style="font-family: Segoe UI, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #fff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
            ...
            <div style="background: #fee2e2; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #dc2626;">
                ...
                <p style="margin: 8px 0 0 0;"><strong>Business Days Overdue:</strong> <span style="color: #dc2626; font-weight: bold;">{{daysOverdue}} business day(s)</span></p>
...
PRINT 'Updated action_plan_escalation template';

-- Update Action Plan Overdue Template (sent to Store Manager)
UPDATE EmailTemplates 
SET 
    html_body = '<div style="font-family: Segoe UI, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); padding: 20px; border-radius: 12px 12px 0 0; text-align: center;">
...
PRINT 'Updated action_plan_overdue template';
PRINT '';
PRINT 'All email templates updated to use business days wording!';
GO
