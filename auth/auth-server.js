...
class AuthServer {
    ...
    setupRoutes() {
        ...
        // ==========================================
        // Notification History API Routes - MOVED to auth-app.js for SQL-driven permissions
        // These routes are now defined in auth-app.js with requirePagePermission(NOTIFICATION_PAGE, ...)
        // ==========================================
