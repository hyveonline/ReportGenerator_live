    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #f4f4f4; padding: 20px 0;">
        <tr>
            ...
            },
            {
                ...
                placeholders: ['recipientName', 'storeName', 'documentNumber', 'auditDate', 'score', 'scoreColor', 'statusText', 'statusEmoji', 'statusColor', 'statusBgColor', 'passingGrade', 'reportUrl', 'dashboardUrl', 'auditorName'],
                html_body: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
