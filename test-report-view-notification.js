/**
 * Test script to preview Report View Notification email
...
async function testReportViewNotification() {
    ...
    console.log('👥 Recipients (who would receive notification):');
    ...
    console.log('');
    console.log('Body (Text version):');
    console.log('─'.repeat(40));
    console.log(`
📋 Report Viewed Notification

👤 ${viewerName} (${viewerRole}) has viewed the audit report.

🏪 Store: ${audit.StoreName}
📋 Document #: ${audit.DocumentNumber}
📅 Audit Date: ${auditDate}
🎯 Score: ${score}
🕐 Viewed At: ${viewedAt}

View Report: https://fsaudit.gmrlapps.com/api/audits/reports/Audit_Report_${audit.DocumentNumber}.html
`);
    console.log('─'.repeat(60));
    
    // 5. Save HTML preview to file
    const htmlEmail = `
<!DOCTYPE html>
<html>
...
`;
    ...
    console.log(`\n✅ HTML email preview saved to: ${previewPath}`);
